<div>
    <div class="p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
        <h2 class="mb-4 text-2xl font-semibold">Edit SchoolClass</h2>
        ...
        <form wire:submit="update">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ '{{' }} route('schoolclass.index') {{ '}}' }}" class="px-4 py-2 text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300">Cancel</a>
            </div>
        </form>
    </div>
</div>