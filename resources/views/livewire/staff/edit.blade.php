<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Add New Staff</h2>
    </x-slot>
                ...
                <form wire:submit.prevent="save" class="p-6 sm:p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                @error('joining_date') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                            </div>
                            <div class="sm:col-span-2">
                    ...
                    {{-- Photo Upload --}}
                     <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Max size: 1MB.</p>
                        <div class="mt-4">
                            <input type="file" wire:model="image" id="image" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"/>
                             @if ($image)
                                <div class="mt-4"><img src="{{ $image->temporaryUrl() }}" class="mt-2 h-24 w-24 rounded-full object-cover"></div>
                            @endif
